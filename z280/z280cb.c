...
OP(cb,30) { cpustate->_B = TSET(cpustate, cpustate->_B);                                        } /* TSET  B           */
OP(cb,31) { cpustate->_C = TSET(cpustate, cpustate->_C);                                        } /* TSET  C           */
OP(cb,32) { cpustate->_D = TSET(cpustate, cpustate->_D);                                        } /* TSET  D           */
OP(cb,33) { cpustate->_E = TSET(cpustate, cpustate->_E);                                        } /* TSET  E           */
OP(cb,34) { cpustate->_H = TSET(cpustate, cpustate->_H);                                        } /* TSET  H           */
OP(cb,35) { cpustate->_L = TSET(cpustate, cpustate->_L);                                        } /* TSET  L           */
OP(cb,36) { WM(cpustate,  cpustate->_HL, TSET(cpustate, RM(cpustate, cpustate->_HL)) );                             } /* TSET  (HL)        */
OP(cb,37) { cpustate->_A = TSET(cpustate, cpustate->_A);                                        } /* TSET  A           */
