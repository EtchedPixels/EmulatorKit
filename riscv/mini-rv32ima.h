...
#ifndef MINIRV32_IO_OFFSET
#define MINIRV32_IO_OFFSET	0x10000000
#define MINIRV32_IO_SIZE	0x02000000
#endif
		...
		else
		{
			...
			switch( ir & 0x7f )
			{
				...
				case 0b0000011: // Load
				{
					...
					{
						rsval += MINIRV32_RAM_IMAGE_OFFSET;
						if( rsval >= MINIRV32_IO_OFFSET && rsval < MINIRV32_IO_OFFSET + MINIRV32_IO_SIZE )
						{
