/*
 *	From the font dumps. In reality this is a bit of a lie. The actual
 *	ROM does not have the first 3 or last two scan lines and is only 5bits
 *	wide. It's just easier to keep all 12 for software
 */
static uint8_t font[64][12] = {
